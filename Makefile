...
#---------------------------------------------------------------------------------
TITLE		:=	Hello World - FrontendTitan
APPID		:=	FTHELLOWRLD
CONTENTID	:=	UP1231-$(APPID)_00-0000000000000000
ICON0 		:=  ICON0.png
...
#---------------------------------------------------------------------------------
LIBS		:=	-lfont -lfreetype -ltiny3d -lz -lsimdmath -lgcm_sys -lio -lsysutil -lrt -llv2 -lsysmodule -lm
